...
const About = () => {
  return (
    <>
        ...
        <motion.div>
            <a download="" href="https://firebasestorage.googleapis.com/v0/b/my-portfolio-9f8a9.appspot.com/o/Ufuoma-Portfolio.pdf?alt=media&token=a578cfe7-45d7-4f0e-88b1-d421ff8a67bb" class="button button--flex" target='_blank'>
